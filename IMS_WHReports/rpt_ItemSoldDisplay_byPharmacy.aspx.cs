...
namespace IMS
{
    public partial class rpt_ItemSoldDisplay_byPharmacy : System.Web.UI.Page
    {
        public DataSet ds;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DisplayMainGrid((DataTable)Session["dtItemSoldPharmacy"]);
        ...
        public void LoadData()
        {
            ...
            try
            {
                        ...
                        Session["rptItemSoldDateTo"] != null && Session["rptItemSoldDateTo"].ToString() != "")
                    {
                        ...
                        Session["dtItemSoldPharmacy"] = dtFiltered;
                    }
                    else
                    {
                        Session["dtItemSoldPharmacy"] = ds.Tables[0];
                    }
            }
            catch (Exception ex)
            {
