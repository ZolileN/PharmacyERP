<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rpt_ucCategory.ascx.cs" Inherits="IMS_WHReports.UserControl.rpt_ucCategory" %>
<div style="margin-top: -144px; display: block;" class="popupMain" id="department">

        <div class="popupHead">Category List
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="ID" Visible="false">
                <ItemTemplate>
                    <asp:Label ID="lbCatID" runat="server" Text='<%# Eval("CategoryID") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
