<%@ Page Language="C#"  MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="rpt_NonHaadMedicinesList.aspx.cs" Inherits="IMS.rpt_NonHaadMedicinesList" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table width="100%">

        <tbody><tr>
        	<td> <h4>Non HAAD List Report</h4></td>
            <td align="right">
