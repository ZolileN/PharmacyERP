...
namespace IMS
{
    public partial class WHResquestInvoice : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["Id"] != null)
                {
                    ...
                    PO_Number.Text = transferID.ToString();
                }
                DataSet dsProducts = (DataSet)Session["dsProducts_WHSOGen"];
        ...
        private void LoadData()
        {
            try
            {
                ...
                if (Request.QueryString["Id"] != null)
                {
                    ...
                    command.Parameters.AddWithValue("@p_OrderNo", transferID);
        ...
        {
            IMSCommon.Util.XLSPrintingUtility.Convert(ProductSet, "SalesOrder_" + PO_ToName.Text + "_" + System.DateTime.Now.ToShortDateString(), Response);
        ...
        private void ExportGridToPDF()
        {
            try
            {
                ...
                {
                    int transferID = int.Parse(Request.QueryString["Id"].ToString());
                    String FileName = "TO_" + transferID.ToString() + ".pdf";
