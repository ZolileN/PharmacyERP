                    ...
                    <asp:TemplateField  HeaderText="Batch<br>No." >
                     ...
                     <asp:TemplateField HeaderText="Bonus<br>Qty" >
                      ...
                      <asp:TemplateField HeaderText="Accepted<br>Qty" >
                        <ItemTemplate>
                             <asp:TextBox ID="DelieveredQtyVal" ReadOnly="true"  runat="server" Text=' <%#Eval("SendQuantity")==DBNull.Value? int.Parse(Eval("DelieveredQty").ToString()) :int.Parse(Eval("SendQuantity").ToString())  %> ' Width="47px"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle  Width="110px" HorizontalAlign="Left"/>
                    </asp:TemplateField>
                     ...
                     <asp:TemplateField HeaderText="Accepted<br>Bonus Qty">
                        ...
                        <ItemTemplate>
                             <asp:TextBox ID="delBonusQtyVal"  runat="server" Text=' <%#Eval("OrderedBonusQuantity")==DBNull.Value? int.Parse(Eval("BonusQuantity").ToString()) :int.Parse( Eval("OrderedBonusQuantity").ToString())  %> '   Width="47px"></asp:TextBox>
                         </ItemTemplate>
                        <ItemStyle  Width="110px" HorizontalAlign="Left"/>
                    </asp:TemplateField>
