<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rpt_ItemSoldDisplay_byPharmacy.aspx.cs" Inherits="IMS.rpt_ItemSoldDisplay_byPharmacy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table width="100%">
        ...
        <tbody><tr>
        	<td> <h4>Item Sold Report by Pharmacy</h4></td>
            <td align="right">
