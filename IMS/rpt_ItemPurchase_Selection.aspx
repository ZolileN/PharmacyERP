<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rpt_ItemPurchase_Selection.aspx.cs" Inherits="IMS.rpt_ItemPurchase_Selection" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <tbody><tr>
        	<td> <h4>Item Pruchase Report</h4></td>
            <td align="right">
    ...
    <table class="formTbl" width="100%">
        ...
        <tr>
            <td><asp:label ID="lblCustomers" runat="server"><b>Vendor:</b></asp:label></td>
            <td>
            ...
            <td>
			     <asp:DropDownList ID="ddlBarterCustomer" runat="server" OnSelectedIndexChanged="ddlBarterCustomer_SelectedIndexChanged" Enabled="false"></asp:DropDownList>
			</td>
        </tr>
