...
namespace IMS
{
    public partial class DirectManualPurchase : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["isEditable"]!=null && Session["isEditable"].ToString().Equals("False")) {
                isEditable = true;
                btnDecline.Enabled = false;
                ProductsAddition.Visible = false;
            }
        ...
        protected void btnCancelOrder_Click(object sender, EventArgs e)
        {
            lblttlcst.Visible = false;
                ...
                Response.Redirect("ViewDirectPurchaseRequests.aspx", false);
