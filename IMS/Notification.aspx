<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notification.aspx.cs" Inherits="IMS.Notification" %>
                            ...
                            <div class="circle s">
                              <svg class="svg-light" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="info" id="AcceptedOfMe" style="display:none">
                                    <span>Transfer Request Accepted</span>
                                    <span>By: <%#Eval("SystemName") %></span>
                                </div>
