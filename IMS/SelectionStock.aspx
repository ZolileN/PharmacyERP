            ...
            onrowcommand="StockDisplayGrid_RowCommand" OnRowDataBound="StockDisplayGrid_RowDataBound" onrowdeleting="StockDisplayGrid_RowDeleting" onrowediting="StockDisplayGrid_RowEditing" >
                 <Columns>
                     ...
                     <asp:TemplateField HeaderText="BarCode">
                        <ItemTemplate>
                            <asp:Label ID="BarCode" runat="server" Text='<%# Eval("BarCode") %>' Width="90px"></asp:Label>
                        </ItemTemplate>
                     ...
                     <asp:TemplateField HeaderText="Name">
                        <ItemTemplate>
                            <asp:Label ID="ProductName" runat="server" Text='<%# Eval("ProductName") %>' Width="90px"></asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Expiry" >
                        <ItemTemplate>
                            <asp:Label ID="lblExpiry"  runat="server" Text='<%# Eval("Expiry") %>' Width="100px"></asp:Label>
                        </ItemTemplate>
                       <ItemStyle  Width="100px" HorizontalAlign="Left"/>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Quantity" HeaderStyle-Width ="50px">
                        <ItemTemplate>
                            <asp:Label ID="lblQuantity" runat="server" Text='<%# Eval("Qauntity") %>' Width="50px"></asp:Label>
                        </ItemTemplate>
                      
                        <EditItemTemplate>
                            <asp:TextBox ID="txtQuantity" runat="server" Width="47px" Text='<%#Eval("Qauntity") %>'></asp:TextBox>
                             <asp:RequiredFieldValidator Width="47px" runat="server" ControlToValidate="txtQuantity" CssClass="text-danger" ErrorMessage="The product quantity field is required." />
                        </EditItemTemplate>
                         <ItemStyle  Width="50px" HorizontalAlign="Left"/>
                    </asp:TemplateField>
                                 

                     <asp:TemplateField HeaderText="Unit <br> Cost" HeaderStyle-Width ="50px">
                        <ItemTemplate>
                            <asp:Label ID="lblUnitCostPrice"  runat="server" Text='<%# Eval("CostPrice") %>' Width="50px"></asp:Label>
                        </ItemTemplate>
                       
                        <EditItemTemplate>
                            <asp:TextBox ID="txtUnitCostPrice"  runat="server" Width="47px" Text='<%#Eval("CostPrice") %>'></asp:TextBox>
                     ...
                     <asp:TemplateField HeaderText="Unit<br> Sale" HeaderStyle-Width ="50px">
                        <ItemTemplate>
                            <asp:Label ID="lblUnitSalePrice" runat="server" Text='<%# Eval("SalePrice") %>' Width="50px"></asp:Label>
                        </ItemTemplate>
                       
                        <EditItemTemplate>
                            <asp:TextBox ID="txtUnitSalePrice" runat="server" Width="47px" Text='<%#Eval("SalePrice") %>'></asp:TextBox>
