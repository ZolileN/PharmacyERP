<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DirectManualPurchase.aspx.cs" Inherits="IMS.DirectManualPurchase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <hr>
     <br />
    <div runat="server" id="ProductsAddition">
