...
namespace IMS {
    ...
    public class Profitability : ReportClass {
    ...
    public class CachedProfitability : Component, ICachedReport {
        
        public CachedProfitability() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Profitability rpt = new Profitability();
            rpt.Site = this.Site;
            return rpt;
        }
