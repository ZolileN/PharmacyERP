<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ItemRequestWHPH.aspx.cs" Inherits="IMS.ItemRequestWHPH" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <table cellspacing="5" cellpadding="5" border="0" style="margin-left:5px;" class="formTbl" id="productAdd" width="100%">
       ...
       <tr>
           ...
           <td>
               <asp:TextBox ID="txtSearch" runat="server" CssClass="product" Width="70%"></asp:TextBox>
           ...
           <td>
               <asp:TextBox runat="server" ID="txtDiscount"  autocomplete="off"  style="width:60px"/>
           </td>
           <td>
        ...
        <asp:GridView ID="StockDisplayGrid" CssClass="table table-striped table-bordered table-condensed"  Visible="true" runat="server" AllowPaging="false" PageSize="10" 
                ...
                onrowcommand="StockDisplayGrid_RowCommand"  onrowdeleting="StockDisplayGrid_RowDeleting" onrowediting="StockDisplayGrid_RowEditing" OnRowDataBound="StockDisplayGrid_RowDataBound" >
                 ...
                 <asp:TemplateField HeaderText="Discount %" HeaderStyle-Width="110px">
                    <ItemTemplate>
                        <asp:Label ID="lblUnitDiscount" CssClass="col-md-2 control-label" runat="server" Text='<%# Eval("Discount") %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle Width="110px" HorizontalAlign="Left" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Total<br>Cost Price" HeaderStyle-Width="110px">
                  ...
                  <asp:TemplateField HeaderText="Discount<br>Cost Price" HeaderStyle-Width="110px">
                    <ItemTemplate>
                        <asp:Label ID="tblDiscountPrice" CssClass="col-md-2 control-label" runat="server" Text='<%# Eval("DiscountCostPrice") %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle Width="110px" HorizontalAlign="Left" />
                </asp:TemplateField>
