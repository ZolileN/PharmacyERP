<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rpt_ItemSoldDisplay_bySalesMan.aspx.cs" Inherits="IMS.rpt_ItemSoldDisplay_bySalesMan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table width="100%">
        ...
        <tbody><tr>
        	<td> <h4>Item Sold Report by Sales Man</h4></td>
            <td align="right">
