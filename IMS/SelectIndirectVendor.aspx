<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SelectIndirectVendor.aspx.cs" Inherits="IMS.SelectIndirectVendor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <table width="100%"> 
        <tbody><tr>
        	<td> <h4 id="topHead">Indirect Manual PO(s)</h4></td>
            <td  >
