                 ...
                 <Columns>
                     <asp:TemplateField HeaderText="Action" HeaderStyle-Width ="150px">
                        <ItemTemplate>
                          ...
                          <EditItemTemplate>
                            <asp:LinkButton ID="btnUpdate" Text="Re-Generate Order" CssClass="btn btn-default btn-xs"  runat="server" CommandName="ReGen" Visible='<%# IsStatusComplete((String) Eval("Status")) %>'></asp:LinkButton>
