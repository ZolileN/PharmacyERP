                     ...
                     <asp:TemplateField HeaderText="Action" HeaderStyle-Width ="150px">
                        <ItemTemplate>
                          ...
                          <EditItemTemplate>
                            ...
                            <asp:LinkButton ID="btnView" Text="Update Accepted Order" CssClass="btn btn-default btn-xs"  runat="server" CommandName="UpdateRec" Visible= '<%# IsStatusComplete((String) Eval("Status")) %>' ></asp:LinkButton>
