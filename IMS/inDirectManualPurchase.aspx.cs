...
namespace IMS
{
    public partial class inDirectManualPurchase : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["isEditable"] != null && (Session["isEditable"].ToString().Equals("Complete") || Session["isEditable"].ToString().Equals("Partial") || Session["isEditable"].ToString().Equals("Approved"))) 
            {
        ...
        protected void btnCreateOrder_Click(object sender, EventArgs e)
        {
            ...
            if (quan + bQuan > 0)
            {
                ...
                if (Session["FirstOrder"].Equals(false))
                {
                    ...
                    int pRequestTo = 0;
                    String OrderMode = "";
                    int OrderType = 6;//incase of vendor this should be 3
        ...
        {
            Response.Redirect("inDirectPO_GENERATE.aspx", false);
        }
