            ...
            <div id="MainContent_MAINDIV" class="main">
                ...
                <asp:GridView ID="dgvTransferDisplay" CssClass="table table-striped table-bordered table-condensed" Visible="true" runat="server" AllowPaging="false" PageSize="10"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Requested Bonus Qty" HeaderStyle-Width="150px" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Percentage Discount" HeaderStyle-Width="150px" Visible="false">
                            <ItemTemplate>
