<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="inDirectManualPurchaseWarehouse.aspx.cs" Inherits="IMS.inDirectManualPurchaseWarehouse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table width="100%">
        ...
        <tbody><tr>
            ...
            <td align="right">
                <asp:Button ID="btnAccept" runat="server" OnClick="btnAccept_Click" Text="Approve Request" CssClass="btn btn-success"  />
  ...
  <hr>
     <br />
   <div runat="server" id="ProductAdd">
