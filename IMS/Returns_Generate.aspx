<%@ Page Language="C#"  MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Returns_Generate.aspx.cs" Inherits="IMS.Returns_Generate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="main" id="MAINDIV" runat="server">
        ...
        <h1 class="main-h">RETURNS STATEMENT</h1>

        <table cellpadding="5" width="100%" cellspacing="0">
        	<tr>
            	<td> <asp:Label runat="server" ID="PO_Numberlbl" CssClass="control-label">Return No : </asp:Label> <asp:Label runat="server" ID="PO_Number" CssClass="control-label" Text="---" Width="100px"></asp:Label></td></td>
                <td align="right"><asp:Label runat="server" ID="PO_Datelbl" CssClass="control-label">Return Date : </asp:Label> <span class="date"><asp:Label runat="server" ID="PO_Date" CssClass="control-label" Text="---" Width="300px"></asp:Label></span></td>
        ...
        <br /><br />
          ...
          <table cellpadding="5" width="100%" cellspacing="0">
        	<tr>
               <td valign="top"><strong><asp:Label runat="server" ID="lblVendorType" CssClass="control-label" Text="" Width="100%"></asp:Label></strong><br />
        ...
        <br /><br /><br />
        <asp:GridView ID="gvReturns" CssClass="table table-striped table-bordered table-condensed" runat="server"
    ...
    <div class="main">
     <asp:Button ID="btnPrint" runat="server" OnClientClick="window.print();" Text="PRINT" CssClass="btn btn-primary btn-large no-print" Visible="true" />
                <asp:Button ID="btnEmail" runat="server"  Text="EMAIL" CssClass="btn btn-info btn-large no-print" Visible="true" />
                <asp:Button ID="btnFax" runat="server"  Text="BACK" CssClass="btn btn-default btn-large no-print" OnClick="btnFax_Click" />
        </div>
