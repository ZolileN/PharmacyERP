...
namespace IMS {
    ...
    public class rpt_POSSALES : ReportClass {
        ...
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
        public CrystalDecisions.Shared.IParameterField Parameter_ProductType {
            get {
    ...
    public class Cachedrpt_POSSALES : Component, ICachedReport {
        
        public Cachedrpt_POSSALES() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rpt_POSSALES rpt = new rpt_POSSALES();
            rpt.Site = this.Site;
            return rpt;
        }
