...
namespace IMS
{
    public partial class inDirectManualPurchaseWarehouse : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["isEditable"] != null && (Session["isEditable"].ToString().Equals("Complete") || Session["isEditable"].ToString().Equals("Partial"))) 
            {
                btnAccept.Enabled = false;
                
                ProductAdd.Visible = false;
            }
            if (Session["isEditable"].ToString().Equals("Approved")) {
        ...
        {
            Response.Redirect("inDirectPO_Approve.aspx", false);
        }
